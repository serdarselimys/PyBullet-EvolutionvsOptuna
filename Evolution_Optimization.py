...
#     Run names are prefixed "GA_" so they sit next to "Optuna_" runs in the same
#     TensorBoard for direct GA-vs-Optuna comparison.
...
def run_experiment_worker(args):
    ...
    group_key = f"GA_{mode}_dir{direction}_h{body_height}"
...
if __name__ == "__main__":
    ...
    if all_results:
        ...
        df.to_csv("ga_gait_results.csv", index=False)
        print("\nAll experiments complete. Results saved to ga_gait_results.csv.")
